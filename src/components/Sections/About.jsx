    ...
    return (
        <section className="w-full min-h-screen max-w-5xl mx-auto px-4 font-sans">
            <div className="flex flex-col">
                <div className="p-1 rounded-full animate-text bg-linear-to-r from-teal-300 via-purple-500 to-orange-500 self-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-x-16 pt-16">
                <div className="text-2xl md:text-right uppercase font-bold text-slate-300">
                    I <span className="animate-text font-bold bg-clip-text text-transparent bg-linear-to-r from-red-300 via-red-500 to-orange-500">❤</span>
                </div>
                <div className="text-2xl md:col-start-2 md:col-end-4">
                    <div className="font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-x-16 pt-16">
                ...
                <div className="grid grid-cols-4 text-2xl md:col-start-2 md:col-end-4">
                    <a href="https://www.upwork.com/freelancers/~01cfd344d945d1f282?viewMode=1" target="_blank">
                        <img src={'/upwork.svg'} className="w-12 h-12 rounded-lg object-cover bg-white hover:bg-linear-to-r from-teal-300 via-purple-500 to-orange-500 p-2 focus:text-white hover:animate-text" />
                    </a>
                    <a href="https://www.linkedin.com/in/Sadman-Yasar-Sayem/" target="_blank">
                        <img src={'/linkedin.svg'} className="w-12 h-12 object-cover rounded-lg bg-white hover:bg-linear-to-r from-teal-300 via-purple-500 to-orange-500 p-2 focus:text-white hover:animate-text" />
                    </a>
                    <a href="https://github.com/SadmanYasar" target="_blank">
                        <img src={'/github.svg'} className="w-12 h-12 object-cover rounded-lg bg-white hover:bg-linear-to-r from-teal-300 via-purple-500 to-orange-500 p-2 focus:text-white hover:animate-text" />
                    </a>
                    <a href="https://www.behance.net/sadmanyasar" target="_blank">
                        <img src={'/behance.svg'} className="w-12 h-12 object-cover rounded-lg bg-white hover:bg-linear-to-r from-teal-300 via-purple-500 to-orange-500 p-2 focus:text-white hover:animate-text" />
                    </a>
                </div>
            </div>
        </section>
